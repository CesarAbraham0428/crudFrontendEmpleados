  ...
  abrirDialogo() {
    ...
    eliminarEmpleado(empleado: CargaEmpleadoCursos) {
      // Filtrar el array de empleados seleccionados, eliminando al empleado que se pasó como argumento
      this.empleadosSeleccionados = this.empleadosSeleccionados.filter(e => e.ClaveEmpleado !== empleado.ClaveEmpleado);
    }
